    ...
    return (
        <div className="page">
            <div className="header">
                ...
                <div className="sub">
                    {total} complex interaction patterns across {cats.length} families — editors, command bars, maps,
                    charts, and specialty viewers.
                </div>
            </div>
            <div className="meta-row">
                ...
                <span style={{ marginLeft: "auto" }}>Vol. 08 · Diamond · 2026</span>
            </div>
            <div className="toc">
                {cats.map((c, i) => (
            ...
            >
                <span>— Fin —</span>
                <span>
                    {total} widget patterns · {cats.length} sections
                </span>
