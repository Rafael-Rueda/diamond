...
function App() {
    ...
    const totalCount = cats.reduce((n, c) => n + c.v.length, 0);

    const groups = [
        { title: "I. Containers", idx: [0, 1] },
        { title: "II. Grid Systems", idx: [2, 3] },
        { title: "III. Flex & Alignment", idx: [4, 5, 6] },
        { title: "IV. Separators & Space", idx: [7, 8, 9] },
        { title: "V. Typography", idx: [10, 11, 12] },
        { title: "VI. Accessibility", idx: [13] },
    ];
    ...
    return (
        <div className="page">
            <div className="header">
                ...
                <div className="sub">
                    A systematic catalogue of {totalCount} layout primitives across {cats.length} component families.
                    The bones of every interface — boxes, grids, stacks, typography, and the quiet helpers that make it
                    all hang together.
                </div>
            </div>
            ...
            <div className="meta-row">
                ...
                <span>
                    <span className="dot" />6 Thematic Groups
                </span>
                <span>
                    <span className="dot" />
                    Live tweakable
                </span>
                <span style={{ marginLeft: "auto" }}>Vol. 03 · Edition 2026</span>
            </div>
            ...
            >
                <span>— Fin —</span>
                <span>
                    {totalCount} primitives · {cats.length} sections · {groups.length} groups
                </span>
