...
function App() {
    ...
    const groups = [
        { title: "I. Surfaces & Containers", idx: [0, 3, 4, 5] },
        { title: "II. Data & Tables", idx: [1, 2] },
        { title: "III. Identity & Labels", idx: [6, 7, 8, 9, 10] },
        { title: "IV. Temporal & Spatial", idx: [11, 12, 13, 14] },
        { title: "V. Media", idx: [15, 16, 17] },
        { title: "VI. Content Blocks", idx: [18, 19, 20, 21, 22] },
    ];
    return (
        <div className="page">
            <div className="header">
                ...
                <div className="sub">
                    A systematic catalogue of {total} display primitives across {cats.length} families — the containers,
                    tables, and indicators that surface information.
                </div>
            </div>
            <div className="meta-row">
                ...
                <span style={{ marginLeft: "auto" }}>Vol. 07 · Diamond · 2026</span>
            </div>
            <div className="toc">
                {cats.map((c, i) => (
            ...
            >
                <span>— Fin —</span>
                <span>
                    {total} display patterns · {cats.length} sections
                </span>
