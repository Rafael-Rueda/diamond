    ...
    return (
        <div className="page">
            <div className="header">
                ...
                <div className="sub">
                    A systematic survey of {totalCount} form control variations across {cats.length} component families.
                    Click any cell to copy its class.
                </div>
            </div>
            ...
            <div className="meta-row">
                ...
                <span style={{ marginLeft: "auto" }}>Vol. 01 · Edition 2026</span>
            </div>
            ...
            {cats.map((c, idx) => (
                <section
                    ...
                    id={`sec-${c.k}`}
                    className="section"
                    data-screen-label={`${String(idx + 1).padStart(2, "0")} ${c.n}`}
                >
                    <div className="section-head">
                        <span className="num">§{String(idx + 1).padStart(2, "0")}</span>
                        <h2>{c.n}</h2>
                        <span className="desc">{c.v.length} variations</span>
                    </div>
                    <div className="grid">
                        {c.v.map((V, i) => (
            ...
            >
                <span>— Fin —</span>
                <span>
                    {totalCount} components · {cats.length} sections
                </span>
