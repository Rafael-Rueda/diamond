/* Overlays Gallery — App */
const TWEAKS = /*EDITMODE-BEGIN*/ { accent: "#2b7fff", radius: 12, font: "Inter", bg: "warm" } /*EDITMODE-END*/;
const SWATCHES = [
    "#2b7fff",
    "#e11d48",
    "#10b981",
    ...
    return (
        <div className="page">
            <div className="header">
                ...
                <div className="sub">
                    A catalogue of {total} overlay patterns across {cats.length} families — modals, sheets, drawers,
                    tours, and the quiet banners that bring a conversation forward.
                </div>
            </div>
            <div className="meta-row">
                ...
                <span style={{ marginLeft: "auto" }}>Vol. 04 · Edition 2026</span>
            </div>
            <div className="toc">
                {cats.map((c, i) => (
            ...
            >
                <span>— Fin —</span>
                <span>
                    {total} overlays · {cats.length} sections
                </span>
